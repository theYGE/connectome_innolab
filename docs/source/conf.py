...
project = "connectome"
copyright = f"{date.today().year}, Oleksandr Makarevych, Zhiwei Cheng, Simei Li, Thomas Lux, Sven Maurice Morlock"
...
modindex_common_prefix = ["connectome."]
...
htmlhelp_basename = "connectomedoc"
...
texinfo_documents = [
    (
        ...
        "connectome Documentation",
        author,
        "Oleksandr Makarevych, Zhiwei Cheng, Simei Li, Thomas Lux, Sven Maurice Morlock",
